...
int filtrer(int *T, int N){
    ...
    // $ i < N $
        if(!test(T[i])){
        // $ Filtrage(T_{0}, i-1, taille\_utile) \land  Zone\_Morte(T, i-1, taille\_utile) \land \neg p(T[i]) $
            T[i]= 0;
            // $ Filtrage(T_{0}, i, taille\_utile) \land  Zone\_Morte(T, i, taille\_utile) $
            i++;
            // $ Filtrage(T_{0}, i-1, taille\_utile) \land  Zone\_Morte(T, i-1, taille\_utile) $
        }else{
        // $ Filtrage(T_{0}, i-1, taille\_utile) \land  Zone\_Morte(T, i-1, taille\_utile) \land p(T[i]) $
            if(taille_utile!= i){
            // $ Filtrage(T_{0}, i-1, taille\_utile) \land  Zone\_Morte(T, i-1, taille\_utile) \land p(T[i]) \land taille\_utile \neq i $
                T[taille_utile]= T[i];
